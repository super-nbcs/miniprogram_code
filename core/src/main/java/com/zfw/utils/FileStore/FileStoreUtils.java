...
public class FileStoreUtils {
    private static Logger logger = LoggerFactory.getLogger(FileStoreUtils.class);
    ...
    private static String createAndGetDirs() {
        ...
        Path path = Paths.get(systemParentPath() + separator +"significant"+separator+ year + separator + month + separator + day + separator);
     ...
     * @param isForever true是永久文件，false是临时文件
     * @return
     * @throws IOException
     */
    ...
    public static boolean isPhoto(File file){
        ...
        return StringUtils.endsWithAny(s,"jpg","png");
    }
    ...
    public static String createFilePrefixForNuc(String base64Prefix, boolean isForever) throws IOException {
        ...
        String fileType = base64Prefix.split(",")[0].split(";")[0].split("/")[1];
        Path emptyFile = createEmptyFile("jpg", isForever);
